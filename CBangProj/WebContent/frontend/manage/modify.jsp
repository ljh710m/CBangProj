		...
		<div id="manage-component">
			<div class="manage">
				<div class="manage-navi">
					<div class="lnb-wrap">
						<ul class="lnb">
							<li><a href="#" class="active">매물관리</a></li>					
						</ul>
					</div>
				</div>
				<div class="content">
										...
										<tr>
											...
											<td class="setting-wrap" style="border-left: none;">												
												...
												<c:if test="${not completeFlag}">
													<a href="#" name="수정" class="btn btn-xs btn-white-gray">수정</a>
													<button class="btn btn-xs btn-white-gray" onclick="deleteRoom(${item.room_no})">삭제</button>
