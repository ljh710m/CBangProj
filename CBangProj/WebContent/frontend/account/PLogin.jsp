...
<body>
	...
	<div id="body" class="col-md-8 col-md-offset-2">
		<div>
			<h1>회원가입</h1>
			<p>필요서류를 미리 준비해 두시면 빠르게 가입 하실 수 있습니다.
						<br />
				<em>고객센터 1899-6840/팩스번호 02-554</em>
			</p>
		</div>
	...
	<div id="body2" class="col-md-8 col-md-offset-2">
		<table class="table table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<span class="input--dash"> - </span>
					<input type="number" max="9999" class="number" name="phone" required maxlength="4" />
					<span class="input--dash"> - </span>
					<input type="number" max="9999" class="number" name="phone" required maxlength="4" />
					</td>
				</tr>
				...
				<tr>
					...
					<input type="text" class="Email--input" name="email" required autocomplete="off" />
					<span class="input--dash"> @ </span>
					<select>
				...
				<tr>
					...
					<td><input type="password" placeholder="8자 이상, 문자, 숫자, 특수문자 포함" /></td>
				</tr>
				<tr>
		...
		<div>
			<small>*공인중개사법 제18조 2의 취지에 적합한 표시의무(상호명, 등록관청에 신고된 전화번호, 소재지,
				성명)를 기입하시기 바랍니다. 이에 발생한 문제는 (주)스테이션3 에서 책임을 지지 않습니다.</small>
		</div>
