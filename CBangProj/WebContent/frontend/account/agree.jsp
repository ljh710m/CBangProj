...
<div id="agree" class="modal fade" role="dialog"
	...
	<div class="agree-modal" style="display: block;">
		...
		<div class="agree-modal-dialog"
			style="width: 530px; padding-right: 20px; padding-left: 20px; height: 670px;">
								...
								<div class="Agreement">
									<div class="Agreement-terms">
										...
										<label class="Checkbox Checkbox--chk" style="float: right;">
											...
											<input type="checkbox" class="Checkbox-input" shape="chk"
									...
									<div class="Agreement-terms">
										...
										</i> <input type="checkbox" class="Checkbox-input" shape="chk"
									...
									<div class="Agreement-terms"
										...
										<label class="Checkbox Checkbox--chk"> <i
											...
											label="모두 동의합니다." id="allcheck"> <span class="Checkbox-label">모두
												동의합니다.</span>
										</label>
									</div>
									<div class="Agreement-nav">
										<button style="font-size: 15px;"
											class="Agreement-nav__btn btn btn-white-gray btn-lg border-radius-large"
											data-dismiss="modal">취소</button>
										<button style="font-size: 15px; color: #d1d1d1"
											class="Agreement-nav__btn btn btn-default btn-lg border-radius-large"
