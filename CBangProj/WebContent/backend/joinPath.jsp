...
<body>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right" style="cursor: pointer;">
                            <li>회원 정보 조회</li>
                            <li>공인중개사 관리</li>
                            <li><a href="joinPath.admin">가입 경로</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">가입 경로</strong>
                        </div>
                        <div class="card-body">
                        	<div class="row">
	                        	<div class="col-lg-6">        	
		                            <table class="table table-hover">
		                            	<thead>
		                                	<tr>
		                                  		<th scope="col">#</th>
		                                  		<th scope="col">경로코드</th>
		                                  		<th scope="col">경로종류</th>
		                                  		<th scope="col"></th>
		                              		</tr>
			                          	</thead>
			                          	<tbody id="privilege">
			                        <c:if test="${empty requestScope.joinPathList }" var="flag">
							 				<tr>
							 					<td colspan="4" style="text-align: center;">등록된 가입 경로가 없습니다</td>
							 				</tr>
									</c:if>
									<c:if test="${not flag }">
										<c:forEach var="item" items="${requestScope.joinPathList}" varStatus="loop">
							  				<tr>
							  					<th>${map.totalRecordCount - (((map.nowPage - 1) * map.pageSize) + loop.index)}</th>							  					
							  					<td>${item.path_code}</td>
		                  		...
		                  		<div class="offset-lg-1 col-lg-5">
		                  			<div class="card">
				                        <div class="card-header">
				                            <strong class="card-title">가입 경로 등록</strong>
				                        </div>
                        				<div class="card-body">
					                  		<table class="table table-bordered">
					                          	...
					                          	<tbody>
					                            	<tr>
					                              		<th style="background-color: #EBF5FF">경로코드</th>
					                              		<td>자동생성</td>			                              		
					                          		</tr>
					                          		<tr>
					                          			<th style="background-color: #EBF5FF;">경로종류</th>
					                              		<td>
					                              			<div class="row form-group">
		                            							<div class="col"><input type="text" placeholder="경로종류" class="form-control" id="path_name"></div>
		                          							</div>
		                          						</td>
					                          		</tr>
					                          		<tr>
    ...
    <script src="<c:url value='/js/account/joinPath.js'/>"></script>
