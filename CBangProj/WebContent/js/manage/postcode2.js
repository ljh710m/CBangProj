$(function() {
	...
	//지도를 생성
	var initMap = new daum.maps.Map(mapContainer, initMapOption);
	
	//마우스 휠이나 멀티터치로 지도 확대, 축소 기능을 막기
	initMap.setZoomable(false);
	
	// 지도에 표시할 원을 생성합니다
	var initcircle = new daum.maps.Circle({
	    center : new daum.maps.LatLng(initLat, initLng),  // 원의 중심좌표 입니다 
